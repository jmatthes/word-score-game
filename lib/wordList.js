...
var Word_List = (function() {
    ...
    function listCheck(toCheck) {
        console.log('toCheck - - -',toCheck, toCheck.indexOf('_'))
        if(toCheck.indexOf('_')>0||toCheck=='_'){
            console.log('index contains _')
             var regStr= checkRegInWord(toCheck.toLowerCase())
